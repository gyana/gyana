...
def _get_bq_ids_from_bq_tables(bq_tables):
...
def test_get_bq_tables_for_connector_event_tracking(
    ...
    assert _get_bq_ids_from_bq_tables(bq_tables) == {
        "dataset.table_1",
        "dataset.table_2",
        "dataset.table_3",
    }
...
def test_get_bq_tables_for_connector_database(bigquery):
